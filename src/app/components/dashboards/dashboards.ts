...
@Component({
  ...
  host: {
    '[style.--notification-row]':
      'isNotificationBar && !isLayoutExpanded() ? "42px" : "0px"',
    '[style.--header-row]':
      'isLayoutExpanded() ? "0px" : "48px"',
    '[style.--sidebar-col]':
      'isLayoutExpanded() ? "0px" : "auto"',
    '[style.--aside-col]':
      'isLayoutExpanded() || !isAside ? "0px" : "auto"',
    ...
    '[style.--sidebar-grid-area]':
      'isSidebar && !isLayoutExpanded() ? "sidebar" : "main"',
...
export class Dashboards {
  ...
  protected readonly isLayoutExpanded: WritableSignal<boolean> = this.dashboardSpaceLayoutService.isExpanded;
