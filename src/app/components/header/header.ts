...
import {
  NavDropdownConfig,
  NavDropdownConfigType,
} from './_components/nav-dropdown/nav-dropdown.model';
...
export class Header {
  ...
  dropdownConfig2: NavDropdownConfig = {
    ...
    type: NavDropdownConfigType['multi-columned'],
    placeholdersItem: [
      ['Marketing', 'Engineering', 'Design', 'Operations', 'IT'],
      ['Planning', 'Campaign Management', 'Agile Project Management', 'Program Management'],
      ['Enterprise'],
    ],
