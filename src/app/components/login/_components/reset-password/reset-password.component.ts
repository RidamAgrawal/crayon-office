...
export class ResetPasswordComponent {
    ...
    protected readonly isDisabled = computed(() => !(this.recoveryEmail() && !this.validateEmail(this.recoveryEmail())));
    protected readonly isResetDisabled = computed(() => !(this.newPassword() && this.confirmPassword() && (this.newPassword() === this.confirmPassword()) && !this.validatePassword(this.newPassword()) && !this.validatePassword(this.confirmPassword())));
    protected readonly isNotMatch = computed(() => !!(this.newPassword() && this.confirmPassword() && !this.validatePassword(this.newPassword()) && !this.validatePassword(this.confirmPassword()) && this.newPassword() !== this.confirmPassword()));
    ...
    protected onResendRecoveryLink(): void {
        ...
        this.httpService.sendRecoveryLink(this.recoveryEmail())
            .pipe(
    ...
    protected onResetPassword(): void {
        ...
        this.isSending.set(true);
        this.serverError.set('');
        this.httpService.resetPassword(this.token(), this.newPassword())
